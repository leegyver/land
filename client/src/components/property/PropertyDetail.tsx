    ...
    <div className="container mx-auto px-4 py-10">
      <div className="mb-8">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-3">
          {/* 부동산 유형 뱃지 */}
          <Badge
            className={`text-sm font-medium ${property.type === "아파트" || property.type === "아파트연립다세대" ? "bg-blue-500" :
          ...
          {property.dealType && Array.isArray(property.dealType) && property.dealType
            ...
            .map((type, index) => (
              <Badge
                key={index}
                className={`text-sm font-medium ${type === "매매" ? "bg-red-600" :
        ...
        <div>
          ...
          <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
            ...
            <div className="space-y-3">
              <Button
                className="w-full h-12 text-lg bg-[#FEE500] hover:bg-[#FDD835] text-[#191919] border-none font-medium flex items-center justify-center gap-2"
                onClick={() => window.open(siteConfig.kakaoChannelUrl || "http://pf.kakao.com/_xaxbxlxfs/chat", "_blank")}
              >
                <SiKakaotalk className="w-5 h-5" /> 카카오톡 상담
              </Button>

              <Button
                className="w-full h-12 text-lg bg-primary hover:bg-primary/90 text-white font-medium flex items-center justify-center gap-2"
                onClick={() => window.location.href = `tel:${siteConfig.phoneNumber || "010-4787-3120"}`}
              >
