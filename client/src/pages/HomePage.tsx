...
import { Calendar, ArrowRight, Newspaper, Youtube, Play, BookOpen, Home, Video } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="grid grid-cols-2 gap-3">
            <Link href="/properties">
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl p-4 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all cursor-pointer hover:from-blue-700 hover:to-blue-800">
                <Home className="h-6 w-6" />
                <span className="font-bold text-lg">전체매물보기</span>
              </div>
            </Link>
            <Link href="/about">
              <div className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-xl p-4 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all cursor-pointer hover:from-red-700 hover:to-red-800">
                <Video className="h-6 w-6" />
                <span className="font-bold text-lg">영상으로보기</span>
              </div>
            </Link>
          </div>
        </div>
                    ...
                    <CardContent className="p-4 flex-grow">
                      <div className="flex items-center gap-2 mb-2">
                        <Badge variant="outline" className="bg-green-100 text-green-700 border-green-200 text-xs">
                          {post.category === "나의 취미생활" ? "나의 취미생활" : 
                           post.category === "세상이야기" ? "세상이야기" : 
                           post.category === "부동산정보" ? "부동산정보" : 
                           post.category}
                        </Badge>
