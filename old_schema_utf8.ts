...
export const crawledPropertySchema = z.object({
  ...
  rletTpNm: z.string(), // Real Estate Type Name (e.g. ?좎?)
  tradTpNm: z.string(), // Trade Type Name (e.g. 留ㅻℓ)
  ...
  landType: z.string().optional().nullable(), // Land Category (吏紐?
  zoneType: z.string().optional().nullable(), // Zone Type (?⑸룄吏??
